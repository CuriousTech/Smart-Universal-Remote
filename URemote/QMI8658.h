...
{
    QMI8658Register_WhoAmI = 0, // 0 FIS device identifier register
    QMI8658Register_Revision, // 1   FIS hardware revision register
    QMI8658Register_Ctrl1, // 2     General and power management modes
    QMI8658Register_Ctrl2, // 3     Accelerometer control
    QMI8658Register_Ctrl3, // 4     Gyroscope control
    QMI8658Register_Ctrl4, // 5     Magnetometer control
    QMI8658Register_Ctrl5, // 6     Data processing settings
    QMI8658Register_Ctrl6, // 7     AttitudeEngine control
    QMI8658Register_Ctrl7, // 8     Sensor enabled status
    QMI8658Register_Ctrl8, // 9     Reserved - do not write
    QMI8658Register_Ctrl9, // 10    Host command register
    QMI8658Register_Cal1_L = 11,    /*! \brief Calibration register 1 most significant byte. */
    QMI8658Register_Cal1_H,    /*! \brief Calibration register 1 least significant byte. */
    QMI8658Register_Cal2_L,    /*! \brief Calibration register 2 most significant byte. */
    QMI8658Register_Cal2_H,    /*! \brief Calibration register 2 least significant byte. */
    QMI8658Register_Cal3_L,    /*! \brief Calibration register 3 most significant byte. */
    QMI8658Register_Cal3_H,    /*! \brief Calibration register 3 least significant byte. */
    QMI8658Register_Cal4_L,    /*! \brief Calibration register 4 most significant byte. */
    QMI8658Register_Cal4_H,    /*! \brief Calibration register 4 least significant byte. */
    QMI8658Register_FifoCtrl = 19,    /*! \brief FIFO control register. */
    QMI8658Register_FifoData, // 20    brief FIFO data register.
    QMI8658Register_FifoStatus, // 21    /*! \brief FIFO status register. */
    QMI8658Register_StatusInt = 45,    /*! \brief Output data overrun and availability. */
    QMI8658Register_Status0,    /*! \brief Output data overrun and availability. */
    QMI8658Register_Status1,    /*! \brief Miscellaneous status register. */
    QMI8658Register_Timestamp_L = 48,    /*! \brief timestamp low. */
    QMI8658Register_Timestamp_M,    /*! \brief timestamp low. */
    QMI8658Register_Timestamp_H,    /*! \brief timestamp low. */
    QMI8658Register_Tempearture_L = 51,    /*! \brief tempearture low. */
    QMI8658Register_Tempearture_H,    /*! \brief tempearture low. */
    QMI8658Register_Ax_L = 53,    /*! \brief Accelerometer X axis least significant byte. */
    QMI8658Register_Ax_H,    /*! \brief Accelerometer X axis most significant byte. */
    QMI8658Register_Ay_L,    /*! \brief Accelerometer Y axis least significant byte. */
    QMI8658Register_Ay_H,    /*! \brief Accelerometer Y axis most significant byte. */
    QMI8658Register_Az_L,    /*! \brief Accelerometer Z axis least significant byte. */
    QMI8658Register_Az_H,    /*! \brief Accelerometer Z axis most significant byte. */
    QMI8658Register_Gx_L = 59,    /*! \brief Gyroscope X axis least significant byte. */
    QMI8658Register_Gx_H,    /*! \brief Gyroscope X axis most significant byte. */
    QMI8658Register_Gy_L,    /*! \brief Gyroscope Y axis least significant byte. */
    QMI8658Register_Gy_H,    /*! \brief Gyroscope Y axis most significant byte. */
    QMI8658Register_Gz_L,    /*! \brief Gyroscope Z axis least significant byte. */
    QMI8658Register_Gz_H,    /*! \brief Gyroscope Z axis most significant byte. */
    QMI8658Register_Mx_L = 65,    /*! \brief Magnetometer X axis least significant byte. */
    QMI8658Register_Mx_H,    /*! \brief Magnetometer X axis most significant byte. */
    QMI8658Register_My_L,    /*! \brief Magnetometer Y axis least significant byte. */
    QMI8658Register_My_H,    /*! \brief Magnetometer Y axis most significant byte. */
    QMI8658Register_Mz_L,    /*! \brief Magnetometer Z axis least significant byte. */
    QMI8658Register_Mz_H,    /*! \brief Magnetometer Z axis most significant byte. */
    QMI8658Register_Q1_L = 73,    /*! \brief Quaternion increment W least significant byte. */
    QMI8658Register_Q1_H,    /*! \brief Quaternion increment W most significant byte. */
    QMI8658Register_Q2_L,    /*! \brief Quaternion increment X least significant byte. */
    QMI8658Register_Q2_H,    /*! \brief Quaternion increment X most significant byte. */
    QMI8658Register_Q3_L,    /*! \brief Quaternion increment Y least significant byte. */
    QMI8658Register_Q3_H,    /*! \brief Quaternion increment Y most significant byte. */
    QMI8658Register_Q4_L,    /*! \brief Quaternion increment Z least significant byte. */
    QMI8658Register_Q4_H,    /*! \brief Quaternion increment Z most significant byte. */
    QMI8658Register_Dvx_L = 81,    /*! \brief Velocity increment X least significant byte. */
    QMI8658Register_Dvx_H,    /*! \brief Velocity increment X most significant byte. */
    QMI8658Register_Dvy_L,    /*! \brief Velocity increment Y least significant byte. */
    QMI8658Register_Dvy_H,    /*! \brief Velocity increment Y most significant byte. */
    QMI8658Register_Dvz_L,    /*! \brief Velocity increment Z least significant byte. */
    QMI8658Register_Dvz_H,    /*! \brief Velocity increment Z most significant byte. */
    QMI8658Register_AeReg1 = 87,    /*! \brief AttitudeEngine reg1. */
    QMI8658Register_AeOverflow,    /*! \brief AttitudeEngine overflow flags. */
...
#define QMI8658_AE_SAMPLE_SIZE ((4 + 3 + 1) * sizeof(short) + sizeof(uint8_t))
...
{
    QMI8658_Int1 = (0 << 6),    /*! \brief FIS INT1 line. */
    QMI8658_Int2 = (1 << 6)    /*! \brief FIS INT2 line. */
};
...
public:
  ...
  void reset(bool waitResult = true, uint32_t timeout = 500);
  uint8_t readStatus0(void);
  uint8_t readStatus1(void);
  float readTemp(void);
  void setWakeOnMotion(bool bEnable);
private:
  void write_regs(uint8_t reg, uint8_t *value, uint8_t len);
  ...
  void config_mag(enum QMI8658_MagDev device, enum QMI8658_MagOdr odr);
  void config_ae(enum QMI8658_AeOdr odr);

  uint16_t acc_lsb_div = 0;
  uint16_t gyro_lsb_div = 0;
  uint16_t ae_q_lsb_div = (1 << 14);
  uint16_t ae_v_lsb_div = (1 << 10);
